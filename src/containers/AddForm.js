...
export default ()=>{
    ...
    const handleSubmit = event =>{
        ...
        axios.post('https://js-test-api.etnetera.cz/api/v1/phones',newDevice,
    ...
    return(
        <AddForm onSubmit={handleSubmit}>
            ...
            <input type="text" name="vendor" onChange={handleChange} placeholder="Výrobce" required/>
            <input type="text" name="model" onChange={handleChange} placeholder="Model" required/>
            <input type="text" name="osVersion" onChange={handleChange} placeholder="Verze operačního systému" required/>
            <input type="url" name="image" placeholder="Obrázek(URL)" onChange={handleChange}/>
